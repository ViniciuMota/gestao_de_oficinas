      ...
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            ...
            <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4 p-2">
              Ao continuar, você concorda com nossos{" "}
              <AlertDialog>
                <AlertDialogTrigger className="cursor-pointer border-b-2 hover:text-black hover:border-gray-500">
                  Termos de Serviço
                </AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>Termos de Serviço</AlertDialogTitle>
                    <AlertDialogDescription>
                      Bem-vindo ao nosso app! Ao utilizar nosso aplicativo, você
                      concorda com os seguintes termos:<br></br>
                      1. Uso do Serviço Você deve ter pelo menos 18 anos ou
                      permissão dos responsáveis para usar este app. Você se
                      compromete a não usar o app para fins ilegais ou abusivos.
                      <br></br>
                      2. Conta do Usuário Você é responsável por manter a
                      confidencialidade de sua conta e senha. Reservamo-nos o
                      direito de suspender contas que violem estes termos.
                      <br></br>
                      3. Modificações no Serviço Podemos modificar, suspender ou
                      encerrar o app a qualquer momento, sem aviso prévio.
                      <br></br>
                      4. Propriedade Intelectual Todos os direitos do conteúdo,
                      marca e tecnologia do app pertencem a nossa equipe.
                      <br></br>
                      5. Limitação de Responsabilidade Não nos responsabilizamos
                      por danos diretos ou indiretos decorrentes do uso do app.
                      <br></br>
                      6. Foro Este contrato é regido pelas leis do Brasil.
                      Qualquer disputa será resolvida no foro da comarca de São
                      Paulo. Última atualização: 16/07/2025
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
